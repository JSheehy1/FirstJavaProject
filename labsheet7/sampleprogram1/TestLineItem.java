...
public class TestLineItem {
    public static void main(String[] args) {
        ...
        Product p4 = new Product(4,"Marker","This is a black perminent marker");
        ...
        System.out.println("Now changing product associated with the first line-item to a marker...\n\n");
        item1.setProduct(p4);
