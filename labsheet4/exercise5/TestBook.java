...
public class TestBook {
    public static void main(String[] args) {
        ...
        textArea.setText(String.format("%-25s%-9-25s%s","Title","Price","ISBN","Pages"));

        title = JOptionPane.showInputDialog("Please enter the title of ypur favourite book");
        ...
        price = Double.parseDouble(JOptionPane.showInputDialog("Please enter the price of yor least favourite book"));
